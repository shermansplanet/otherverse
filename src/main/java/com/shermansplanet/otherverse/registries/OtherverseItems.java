...
public class OtherverseItems {
    ...
    static {
        for (var spirit : Spirits.colorSpiritTypes) {
            var spindle = ITEMS.register("spindle_" + spirit.label(),
                    () -> {
                        var item = new SpindleItem(new Item.Properties().tab(Otherverse.TAB_PRACTICE));
    ...
    public static final RegistryObject<Item> CHALK = ITEMS.register("chalk",
            () -> new ChalkItem(new Item.Properties().durability(64).tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> CHARCOAL_STICK = ITEMS.register("charcoal_stick",
            () -> new ChalkItem(new Item.Properties().durability(8).tab(Otherverse.TAB_PRACTICE)));
    ...
    public static final RegistryObject<Item> SULFUR_ORE = ITEMS.register("sulfur_ore",
            () -> new BlockItem(OtherverseBlocks.SULFUR_ORE.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> SALT_CRYSTALS = ITEMS.register("salt_crystals",
            () -> new BlockItem(OtherverseBlocks.SALT_CRYSTALS.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    ...
    public static final RegistryObject<Item> WEB_OF_FATE = ITEMS.register("web_of_fate",
            () -> new BlockItem(OtherverseBlocks.WEB_OF_FATE.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    ...
    public static final RegistryObject<Item> FAMILIAR_NAME_TAG = ITEMS.register("familiar_name_tag",
            () -> new FamiliarNameTagItem(new Item.Properties().stacksTo(1).tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> SLATE_SCAFFOLDING = ITEMS.register("slate_scaffolding",
            () -> new BlockItem(OtherverseBlocks.SLATE_SCAFFOLDING.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    ...
    public static final RegistryObject<Item> DEMESNE_BEACON = ITEMS.register("demesne_beacon",
            () -> new BlockItem(OtherverseBlocks.DEMESNE_BEACON.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    ...
    public static final RegistryObject<Item> ANTI_PURPUR_BLOCK_ITEM = ITEMS.register("anti_purpur_block",
            () -> new BlockItem(OtherverseBlocks.ANTI_PURPUR_BLOCK.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> BLANDSTONE_ITEM = ITEMS.register("blandstone",
            () -> new BlockItem(OtherverseBlocks.BLANDSTONE.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> BLANDESITE_ITEM = ITEMS.register("blandesite",
            () -> new BlockItem(OtherverseBlocks.BLANDESITE.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> SERPENT_SOIL_ITEM = ITEMS.register("serpent_soil",
            () -> new BlockItem(OtherverseBlocks.SERPENT_SOIL.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> COOL_BIRCH_PLANKS_ITEM = ITEMS.register("cool_birch_planks",
            () -> new BlockItem(OtherverseBlocks.COOL_BIRCH_PLANKS.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> ROYAL_BRICKS_ITEM = ITEMS.register("royal_bricks",
            () -> new BlockItem(OtherverseBlocks.ROYAL_BRICKS.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> VERDANT_MUD_ITEM = ITEMS.register("verdant_mud",
            () -> new BlockItem(OtherverseBlocks.VERDANT_MUD.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> FOOLS_EMERALD_ITEM = ITEMS.register("fools_emerald",
            () -> new BlockItem(OtherverseBlocks.FOOLS_EMERALD.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> SKIN_CORAL_ITEM = ITEMS.register("skin_coral_block",
            () -> new BlockItem(OtherverseBlocks.SKIN_CORAL_BLOCK.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> FORBIDDEN_CANDY_ITEM = ITEMS.register("forbidden_candy_block",
            () -> new BlockItem(OtherverseBlocks.FORBIDDEN_CANDY_BLOCK.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> PASTEL_QUARTZ_BRICKS_ITEM = ITEMS.register("pastel_quartz_bricks",
            () -> new BlockItem(OtherverseBlocks.PASTEL_QUARTZ_BRICKS.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> BURGUNDY_TILES_ITEM = ITEMS.register("burgundy_tiles",
            () -> new BlockItem(OtherverseBlocks.BURGUNDY_TILES.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
    public static final RegistryObject<Item> CHISELED_PLUMSTONE_ITEM = ITEMS.register("chiseled_plumstone",
            () -> new BlockItem(OtherverseBlocks.CHISELED_PLUMSTONE.get(), new Item.Properties().tab(Otherverse.TAB_PRACTICE)));
