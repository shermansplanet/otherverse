...
@OnlyIn(Dist.CLIENT)
public class SnufferModel<T extends Snuffer> extends AgeableHierarchicalModel<T> {
    ...
    public SnufferModel(ModelPart p_272867_) {
        super(0.5F, 24.0F);
        this.root = p_272867_.getChild("root");
        this.head = this.root.getChild("bone").getChild("body").getChild("head");
        this.body = this.root.getChild("bone").getChild("body");
        this.legs = this.root.getChild("bone");
    }
    ...
    public void setupAnim(T p_273213_, float p_273252_, float p_273344_, float p_272633_, float p_272774_, float p_273206_) {
        ...
        this.legs.yScale = 1.3f;
        this.body.yScale = 1f/1.3f;
        this.legs.y -= 6f;
//        this.body.y += 4f;
