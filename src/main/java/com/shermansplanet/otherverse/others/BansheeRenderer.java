...
@OnlyIn(Dist.CLIENT)
public class BansheeRenderer extends MobRenderer<Phantom, PhantomModel<Phantom>> {
    private static final ResourceLocation PHANTOM_LOCATION = ResourceLocation.fromNamespaceAndPath(Otherverse.MODID, "textures/entity/banshee.png");

    public BansheeRenderer(EntityRendererProvider.Context p_174338_) {
