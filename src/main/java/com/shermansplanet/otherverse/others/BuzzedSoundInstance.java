...
@OnlyIn(Dist.CLIENT)
public abstract class BuzzedSoundInstance extends AbstractTickableSoundInstance {
    private static final float VOLUME_MIN = 0.0F;
    private static final float VOLUME_MAX = 1.2F;
    private static final float PITCH_MIN = 0.0F;
    protected final Buzzed bee;
    private boolean hasSwitched;

    public BuzzedSoundInstance(Buzzed p_119621_, SoundEvent p_119622_, SoundSource p_119623_) {
    ...
    public static class BuzzedFlyingSoundInstance extends BuzzedSoundInstance {
        public BuzzedFlyingSoundInstance(Buzzed p_119615_) {
        ...
        protected AbstractTickableSoundInstance getAlternativeSoundInstance() {
            return new BuzzedAggressiveSoundInstance(this.bee);
        }

        protected boolean shouldSwitchSounds() {
            return this.bee.getTarget() != null;
        }
    }

    public static class BuzzedAggressiveSoundInstance extends BuzzedSoundInstance {
        public BuzzedAggressiveSoundInstance(Buzzed p_119611_) {
            super(p_119611_, SoundEvents.BEE_LOOP_AGGRESSIVE, SoundSource.NEUTRAL);
            this.delay = 0;
        }

        protected AbstractTickableSoundInstance getAlternativeSoundInstance() {
            return new BuzzedFlyingSoundInstance(this.bee);
        }
